 ...
 <div className="d-flex flex-column gap-4"> 
      <img className ="logo-text" src="public/assets/Instagram_text.png" alt="Logo" /> 
     ...
     <div> <img className="ba rounded-circle" style={{width:"30px"}} src="public/assets/profile1.jpeg" alt="pro" />Profile</div>
